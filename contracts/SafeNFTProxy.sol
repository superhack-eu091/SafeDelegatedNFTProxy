...
contract SafeDelegatedERC721Proxy {
    ...
    function transferEtherFromGnosisSafe(
        ...
        // TODO add data for the executor receiver (this contract), nft address, tokenId
    ...
    function canSellNFT(address owner, address nft, uint256 tokenId, address spender) external view returns (bool, uint256) {
        ...
        return (sellingAllowances[key].canBeSold, sellingAllowances[key].minPrice);
    }
    ...
    function sellNFT(address owner, address nft, uint256 tokenId, address destination) external payable {
        ...
        require(msg.value >= sellingAllowances[key].minPrice, "Insufficient payment");
